...
<!--My experience-->
## My experience
### [IT Test](https://ittest-team.ru/)
**May 2023 — Until now** - QA Engineer
- Тестирование WEB сервисов, mobile приложений и VR приложений;
- Анализ текущей и планируемой функциональности сервиса и требований, предъявляемых к работе сервиса;
- Создание кейсов, составление тестовых сценариев;
- Оптимизирование процессов тестирования внутри команды;
- Тестировать backend, frontend и API.
